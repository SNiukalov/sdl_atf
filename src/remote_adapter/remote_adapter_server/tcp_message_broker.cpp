...
template<typename TCPListener>
typename TCPMessageBroker<TCPListener>::ReceiveResult TCPMessageBroker<TCPListener>::Send(
...
template<typename TCPListener>
void TCPMessageBroker<TCPListener>::SendUnprocessedMsg(Context* context,const ConnectionIdent & connect_ident){
    LOG_INFO("{0}",__func__);
